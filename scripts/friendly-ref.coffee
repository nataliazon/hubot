...
module.exports = (robot) ->
  ...
  robot.hear ///
            ...
            $                       # end of the message
            ///i, (msg) ->
    msg.send "Hi @#{msg.message.user.name}! I am a friendly bot here and I can answer some of your questions about the uCreate Studio. Just type my name (#{robot.name}) and follow with any question!"
  ...
  robot.hear ///
            ...
            ///i, (msg) ->
    msg.send "Good #{msg.match[2]}, @#{msg.message.user.name}! I am a friendly bot here and I can answer some of your questions about the uCreate Studio. Just type my name (#{robot.name}) and follow with any question!"
